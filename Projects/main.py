...
#convert labels (continue with 2,3,4 etc. depending on how many classes you have)
...
if __name__ == "__main__":
    patient = Visualization(p_number = PATIENT_NUMBER, plot_artifacts = 1)
    if DO_VISUALIZATION is True:
        patient.plot_annotation_sep_channels()
        patient.plot_annotation_signals()
